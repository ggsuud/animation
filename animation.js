...
Animation.prototype.changePosition = function(ele,positions,imageUrl){
    ...
    if(len){
        ...
        taskFn = function(next,time){
            //如果指定图片，则设置dome对象的背景图片地址
            if(imageUrl){
                ele.style.backgroundImage = "url("+imageUrl+')';
            }
            //获得当前背景图片位置索引
            //time/me.interval |0 ,取最大整数值
